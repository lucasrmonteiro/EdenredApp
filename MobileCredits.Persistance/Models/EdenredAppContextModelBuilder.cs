...
namespace MobileCredits.Persistance.Models
{
    public partial class EdenredAppContextModel
    {
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var balanceAED = FindEntityType("MobileCredits.Domain.Entity.BalanceAED")!;

            var defaultTableMappings = new List<TableMappingBase<ColumnMappingBase>>();
            balanceAED.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings);
            var edenredAppDomainEntityBalanceAEDTableBase = new TableBase("MobileCredits.Domain.Entity.BalanceAED", null, relationalModel);
            ...
            relationalModel.DefaultTables.Add("MobileCredits.Domain.Entity.BalanceAED", edenredAppDomainEntityBalanceAEDTableBase);
            ...
            var beneficiary = FindEntityType("MobileCredits.Domain.Entity.Beneficiary")!;

            var defaultTableMappings0 = new List<TableMappingBase<ColumnMappingBase>>();
            beneficiary.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings0);
            var edenredAppDomainEntityBeneficiaryTableBase = new TableBase("MobileCredits.Domain.Entity.Beneficiary", null, relationalModel);
            ...
            relationalModel.DefaultTables.Add("MobileCredits.Domain.Entity.Beneficiary", edenredAppDomainEntityBeneficiaryTableBase);
            ...
            var user = FindEntityType("MobileCredits.Domain.Entity.User")!;

            var defaultTableMappings1 = new List<TableMappingBase<ColumnMappingBase>>();
            user.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings1);
            var edenredAppDomainEntityUserTableBase = new TableBase("MobileCredits.Domain.Entity.User", null, relationalModel);
            ...
            relationalModel.DefaultTables.Add("MobileCredits.Domain.Entity.User", edenredAppDomainEntityUserTableBase);
            ...
            var pK_UsersUc = RelationalModel.GetKey(this,
                "MobileCredits.Domain.Entity.User",
                new[] { "Id" });
